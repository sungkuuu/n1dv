# Nexus One Weekly Digital Asset Market Report - March 20, 2026
...
| Rank | Ticker | Asset Manager | Product Name | 1-Day Price Change (%) | 7-Day Return (%) | Recent Weekly Flow Trend |
|---|---|---|---|---|---|---|
| 1 | IBIT | BlackRock | iShares Bitcoin Trust | -4.76% | +0.47% | Overwhelming Net Inflow (Max $169M in 1 Day) |
| 2 | FBTC | Fidelity | Fidelity Wise Origin Bitcoin | -4.70% | +0.52% | Maintained Solid Net Inflow |
| 3 | GBTC | Grayscale | Grayscale Bitcoin Trust | -4.72% | +0.53% | Continuous Net Outflow Occurring |
| 4 | ARKB | ARK 21Shares | ARK 21Shares Bitcoin ETF | -4.68% | +0.48% | Limited Net Inflow |
| 5 | BITB | Bitwise | Bitwise Bitcoin ETF Trust | -4.65% | +0.50% | Slight Net Inflow |
| 6 | ETHA | BlackRock | iShares Ethereum Trust | -5.93% | +5.16% | Leading Spot Ethereum Net Inflows |
| 7 | ETH | Grayscale | Grayscale Ethereum Mini | -5.82% | +5.29% | Successfully Attracting New Funds |
| 8 | BITO | ProShares | ProShares Bitcoin Strategy | -4.68% | +0.51% | Futures-based, Maintaining Liquidity |
| 9 | ETHU | Volatility Sh. | 2x Ether ETF (Leveraged) | -11.74% | +8.87% | Speculative Short-term Inflows |
| 10 | SOLT | - | 2x Solana ETF (Leveraged) | -10.72% | +4.51% | High-risk Hedge Fund Inflows |
...
| Rank | Ticker | Asset Manager | Product Name | AUM (CAD) | Fund Characteristics & Liquidity Trends |
|---|---|---|---|---|---|
| 1 | FBTC | Fidelity | Fidelity Advantage Bitcoin ETF | $1.23 Billion | Utilizes proprietary cold storage, #1 in market share & stable inflows |
| 2 | BTCX.B | CI Galaxy | CI Galaxy Bitcoin ETF | $779.59 Million | Continuously attracts institutional funds based on low management fees (0.4%) |
| 3 | BTCC | Purpose | Purpose Bitcoin ETF | $627.22 Million | World's first physically settled spot ETF, core of the liquidity pool |
| 4 | ETHX.U | CI Galaxy | CI Galaxy Ethereum ETF | $362.96 Million | Provides spot Ethereum exposure, pursues USD-pegged returns |
| 5 | ETHH.B | Purpose | Purpose Ether ETF | $182.46 Million | Direct custody Ethereum storage, solid retail fund inflows |
| 6 | EBIT | Evolve | Evolve Bitcoin ETF | $170.71 Million | Strong security based on multi-partnerships (Gemini, CIBC, etc.) |
| 7 | SOLQ | 3iQ | 3iQ Solana Staking ETF | - | Combines Solana spot & staking rewards, explosive inflows |
| 8 | XRPQ | 3iQ | 3iQ XRP ETF | - | Led North America's first XRP ETF listing post-regulatory clarity |
| 9 | BTCY | Purpose | Purpose Bitcoin Yield ETF | - | Utilizes Bitcoin covered call strategies, downside protection & yield generation |
| 10 | ETHR | Evolve | Evolve Ether ETF | - | Hub for Ethereum spot exposure and smart contract infrastructure investment |
...
| Network (Chain) | Category | DeFi TVL ($) | 24h DEX Volume ($) | 24h Protocol Fees ($) | 24h Dapp Revenue ($) | 24h Active Addresses |
|---|---|---|---|---|---|---|
| Ethereum | L1 | 55.79B | 1.44B | 315K ~ 416K | 2.52M | 1.00M |
| Solana | L1 | 6.87B | 2.63B | 537K ~ 601K | 3.02M | 7.42M |
| BSC | L1 | 5.71B | 819.8M | 343K ~ 407K | 707K | 2.64M |
| Base | L2 | 4.14B | 780.8M | 110K ~ 156K | 498K | 492K |
| Tron | L1 | 4.03B | 89.0M | 1.08M ~ 1.09M | 36K | 2.87M |
| Hyperliquid | App-chain | 1.80B | 336.3M | 23K ~ 44K | 2.60M | 53K |
...
| Date | Asset | Event Type | Est. Value | Market Impact & Trading Perspective |
|---|---|---|---|---|
| March 20 | LayerZero (ZRO) | Massive Cliff Unlock | ~$53.19M - $55.53M | Release of Team/VC allocation amounting to 5.64% of supply. Guard against short-term Short positions due to strong selling pressure. |
| March 20 | Lombard (BARD) | Ecosystem Cliff Unlock | ~$35.03M | Massive volume bomb accounting for a staggering 12% of total supply. Evading market shock is essential. |
| March 20 | RIVER | Linear & Cliff Unlock | ~$46.47M | Circulating supply increases by over 10%. Volatility maximization expected. |
| March 23 | Backpack (BP) | TGE & Listing | N/A (New Listing) | Own token launch of the core exchange driving the Solana ecosystem. Expected to act as a black hole for massive venture funds and retail speculative capital. |
| March 28 | Linea | Yield Boost Launch | N/A (Incentive) | Massive interest support campaign to suck up Ethereum L2 liquidity. Will cause rapid shifts in DeFi TVL. |
| Late March | Aster (ASTER) | Own L1 Mainnet | N/A (Mainnet) | Independent chain launch breaking away from existing structure. Opportunity for revaluation as an infrastructure coin. |
